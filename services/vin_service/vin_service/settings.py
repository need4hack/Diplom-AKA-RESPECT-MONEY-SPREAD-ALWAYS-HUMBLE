...
WSGI_APPLICATION = 'vin_service.wsgi.application'
...
NHTSA_API_URL = config('NHTSA_API_URL', default='https://vpic.nhtsa.dot.gov/api/vehicles/DecodeVin/')
